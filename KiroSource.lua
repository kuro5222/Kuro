...
if game.CoreGui:FindFirstChild('KiroUiLib') then
    game.CoreGui:FindFirstChild('KiroUiLib'):Destroy()
    destroyed = true
end
...
local KiroUiLib = Instance.new("ScreenGui")

KiroUiLib.Name = "KiroUiLib"

protect_gui(KiroUiLib)
...
function library:Hide()
   KiroUiLib.Enabled = not KiroUiLib.Enabled
end	
